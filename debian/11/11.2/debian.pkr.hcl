locals {
  debian_version = "11.2"
  iso_checksum   = "sha256:022370f066bc91b2cdac3837ff5fa9f3822c5afb2fc34f68084416079fe5a408"
  iso_url        = "https://cdimage.debian.org/debian-cd/current/amd64/iso-dvd/debian-11.2.0-amd64-DVD-1.iso"
}
